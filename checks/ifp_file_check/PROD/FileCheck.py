...
cwd = os.getcwd()
with open(os.path.join(cwd, 'checks\\ifp_file_check\\PROD\\FileCheck_config.json')) as f:
    config = json.load(f)
...
informentDirectory = config['Informent']['Directory'] + '\\' + str(formated_date) + '\\Backup'
